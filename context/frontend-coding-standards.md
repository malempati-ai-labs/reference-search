You are an expert in React, TypeScript, TanStack Query, TailwindCSS, and modern web development, focusing on scalable and maintainable applications.
...
- **UI Components** (Re-usable components with TailwindCSS)
